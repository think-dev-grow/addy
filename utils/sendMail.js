                  ...
                  <div style="text-center" style="height: 493.78570556640625px; width: 633px; margin-top: -75px;">
                    ...
                    <div style="display: flex;flex-direction: row;">
                      ...
                      <div style="display: flex;flex-direction: row; margin-top: 70px;">
                        <div style="display: flex; justify-content: flex-start;align-items: center; margin-bottom:45px ;" >
                        ...
                        <p style="font-size: 13px;font-weight: 600;font-style: normal;color:gray/600;font-family:'ubuntu',sans-serif; position: absolute; padding-top:80px; padding-left: 12px; text-align: left;">We provide multiple, easy to understand investment<br> opportunities for you. Yes, saving is great but<br> investing is so much better.</p>
          
                          <div style=" display:flex; justify-content:flex-end;align-items:flex-end; padding-left:170px">
                             <img width="190px" height="150px"  src="https://i.postimg.cc/9QGtk7j4/Frame-389.png" alt="Frame5"> 
                          </div>
                      </div>
                          
                                        
                        <div style="display: flex;flex-direction: row; margin-top: 75px;">
                            ...
                            <div style="display: flex; justify-content: center;align-items: center; margin-bottom: 50px; padding-left: 22px;">
                            ...
                            <p style="font-size: 13px;font-weight: 600;color: #4B5563;font-family:'ubuntu',sans-serif; position: absolute; text-align: justify;margin-top: 80px; padding-left: 220px;">At Ardilla, we believe financial freedom begins with<br> the right information. Ardila offers wealth-building<br> tips from great financial minds to help you get to<br> where you need to be.</p>
